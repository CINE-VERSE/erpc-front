...
const fetchContractData = async () => {
    try {
        const response = await axios.get('http://erpc-backend-env-1.eba-thvemdnp.ap-northeast-2.elasticbeanstalk.com/contract/code', {
            params: {
...
const registerOrder = async () => {
    ...
    try {
        const response = await axios.post('http://erpc-backend-env-1.eba-thvemdnp.ap-northeast-2.elasticbeanstalk.com/order/regist', formData, {
            headers: {

...
onMounted(async () => {
    ...
    try {
        const response = await axios.get(`http://erpc-final-backend-env.eba-i73jvuqm.ap-northeast-2.elasticbeanstalk.com/quotation/${quotationId}`, { withCredentials: true });
...
const fetchProductData = async (index) => {
    ...
    try {
        const response = await axios.get('http://erpc-final-backend-env.eba-i73jvuqm.ap-northeast-2.elasticbeanstalk.com/product', { withCredentials: true });
...
const fetchWarehouses = async () => {
    try {
        const response = await axios.get('http://erpc-final-backend-env.eba-i73jvuqm.ap-northeast-2.elasticbeanstalk.com/warehouse', { withCredentials: true });
...
const fetchCustomerData = async () => {
    try {
        const response = await axios.get('http://erpc-final-backend-env.eba-i73jvuqm.ap-northeast-2.elasticbeanstalk.com/account/list', { withCredentials: true });
...
const updateQuotation = async () => {
    ...
    try {
        await axios.patch(`http://erpc-final-backend-env.eba-i73jvuqm.ap-northeast-2.elasticbeanstalk.com/quotation/modify`, formData, {

...
onMounted(async () => {
    ...
    try {
        const response = await axios.get(`http://erpc-final-backend-env.eba-i73jvuqm.ap-northeast-2.elasticbeanstalk.com/account/${accountId}`);
...
const updateAccount = async () => {
    ...
    try {
        const response = await axios.patch(`http://erpc-final-backend-env.eba-i73jvuqm.ap-northeast-2.elasticbeanstalk.com/account/modify`, accountData.value);

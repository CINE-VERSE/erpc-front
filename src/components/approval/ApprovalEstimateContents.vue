...
const fetchApproveQuotationData = async () => {
    ...
    try {
        const response = await axios.get(`http://erpc-backend-env-1.eba-thvemdnp.ap-northeast-2.elasticbeanstalk.com/approval/quotation/${quotationId}`);
...
const submitApproval = async () => {
    ...
    try {
        await axios.patch(`http://erpc-backend-env-1.eba-thvemdnp.ap-northeast-2.elasticbeanstalk.com/approval/quotation/process`, payload);

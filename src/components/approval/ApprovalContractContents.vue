...
const fetchApproveContractData = async () => {
    ...
    try {
        const response = await axios.get(`http://erpc-backend-env.eba-thvemdnp.ap-northeast-2.elasticbeanstalk.com/approval/contract/${contractId}`);
...
const submitApproval = async () => {
    ...
    try {
        await axios.patch(`http://erpc-backend-env.eba-thvemdnp.ap-northeast-2.elasticbeanstalk.com/approval/contract/process`, payload);
